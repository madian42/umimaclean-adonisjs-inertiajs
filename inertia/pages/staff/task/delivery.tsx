...
export default function DeliveryPage({ order }: { order: Order }) {
  ...
  function handleUpload(data: UploadPhotoSchema) {
    router.visit(
      { route: 'staff.delivery.complete', params: { id: order.number } },
      {
        method: 'post',
        data,
        fresh: true,
  ...
  function handleReleaseOrder(data: { note: string }) {
    router.visit(
      { route: 'staff.delivery.cancel', params: { id: order.number } },
      {
        method: 'post',
        data,
        fresh: true,
      ...
      <div className="min-h-screen md:min-h-[calc(100vh-39px)] bg-gray-50 flex flex-col">
        ...
        <div className="bg-white px-4 py-4 border-b sticky sm:top-9 top-0">
          <div className="flex items-center justify-center gap-3">
            <h1 className="text-lg font-semibold text-gray-900">Pengantaran</h1>
          </div>
        </div>
          ...
          <div className="border-t border-gray-200 px-4 py-4 bg-white">
            <div className="space-y-3 w-full">
              ...
              <AlertDialog open={isReleaseDialogOpen} onOpenChange={setIsReleaseDialogOpen}>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Batalkan Pengantaran</AlertDialogTitle>
                    <AlertDialogDescription>
