...
// export default function ShipMode({ booking, stage }: { booking: Booking; stage: string }) {
...
//   const form = useForm<UploadClientPhotoPayload>({
...
//   function handleUpload(data: UploadClientPhotoPayload) {
//     router.visit(
//       { route: 'staff.bookings.upload', params: { id: booking.number, stage } },
//       {
//         method: 'post',
//         data,
//         fresh: true,
//         onSuccess: () => {
//           form.reset()
//           toast.success(`Foto berhasil diunggah pada tahap ${stageMap[stage]}`)
//         },
//         onError: (errors) => {
...
//     router.visit(
//       { route: 'staff.bookings.release', params: { stage, id: booking.id } },
//       {
//         method: 'post',
//         data,
//         fresh: true,
...
//             <h1 className="text-lg font-semibold text-gray-900">{stageMap[stage]}</h1>
//           </div>
//         </div>
...
//                     <p className="text-sm text-gray-700">{booking.address.note}</p>
//                   </div>
//                 </div>
//               )}
